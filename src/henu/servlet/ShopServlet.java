...
public class ShopServlet extends HttpServlet {
    ...
    protected void queryByID(HttpServletRequest request, HttpServletResponse response)
        ...
        JSONObject jsonObject = new JSONObject();
        JSONArray jsonArray = new JSONArray();
        if (request.getParameter("userID") != null) {// 传入店主id
            ...
            writer.print(jsonArray);
        } else if (request.getParameter("shopID") != null) {// 传入商店id
    ...
    /**
     * 修改商店信息(传入用户id或者商店id) 可修改数据：商店名称shopName json{"result":"true/false"}
     *
     * @param request
     * @param response
     * @throws ServletException
